...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) => appStateNotifier.showSplashImage
          ? Builder(
              builder: (context) => Container(
                ...
                child: Image.asset(
                  'assets/images/medium-butcute14365-manga-collage-anime-manga-series-hd-matte-original-imagkph2fdqxpdhy_copiar.png',
                  fit: BoxFit.cover,
                ),
              ),
            )
      ...
      routes: [
        ...
        FFRoute(
          name: 'MangaFocus',
          path: '/mangaFocus',
          builder: (context, params) => MangaFocusWidget(
            ...
            removeFav: params.getParam('removeFav', ParamType.bool),
          ),
        )
